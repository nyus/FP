...
@interface StatusTableViewController ()<StatusObjectDelegate,FBFriendPickerDelegate,FBViewControllerDelegate,UIAlertViewDelegate, StatusTableViewHeaderViewDelegate,StatusTableViewCellDelegate,ExpirationTimePickerViewControllerDelegate>{
